...
#[ignore]
fn test_pow() {
    println!("============> {:?}", pow(BigInt::from(10), 0).to_string());
    println!("============> {:?}", pow(BigInt::from(10), 1).to_string());
    println!("============> {:?}", pow(BigInt::from(10), 2).to_string());
}
...
fn test_eq1() {
    ...
    println!("============> {:?}", decimal("1.0"));
    println!("============> {:?}", decimal("0.1"));
    println!("============> {:?}", decimal("0.01"));
    println!("============> {:?}", decimal("0.001"));
...
#[test]
fn test_mul1() {
    assert_eq!(decimal("1.1") * decimal("2"), decimal("1.1") + decimal("1.1"));
}
